...
const DATA = {
  "yanmar": {
    ...
    "programs": [
      ...
      {
        "id": "y_general15",
        "name": "ทั่วไป 15% (ลูกค้าไม่เข้าเงื่อนไขโปร 20%)",
        "groups": [
          "ทั่วไป"
        ],
        "conditions": [
          ...
          "เลือกงวดผ่อนได้ 7-8 ปีเท่านั้น (ไม่ใช่ 6-10 ปีเหมือนโปร 20%)"
        ],
        "entries": {
          "EF393A": {
            "price": 584000,
